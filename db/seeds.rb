...
ul = City.find_or_create_by_name "Ульяновск", twitter_name: "@ulway", email: "ul@waytag.ru", slug: "ul", hashtag: "ulway"
...
cheb = City.find_or_create_by_name "Чебоксары", twitter_name: "@chebway", email: "cheb@waytag.ru", slug: "cheb", hashtag: "chebway"
...
perm = City.find_or_create_by_name "Пермь", twitter_name: "@Perm_way", email: "perm@waytag.ru", slug: "perm", hashtag: "permway"
...
ekb = City.find_or_create_by_name "Екатеринбург", twitter_name: "@Ekbway", email: "ekbway@waytag.ru", slug: "ekb", hashtag: "ekbway"
